...
### 6.1 High-Level Sequence Diagrams

![HighLevelSeqDiagram](highLevelSeqDiagram.png){ width=0.8\textwidth }  
![HighLevelSeqDiagram2](highLevelSeqDiagram2.png){ width=0.8\textwidth }
...
### 6.2 Detailed Sequence Diagrams

![DetailedUseCaseSequenceDiagram1](detailedUseCaseSequenceDiagram1.png){ width=0.8\textwidth }  
![DetailedUseCaseSequenceDiagram2](detailedUseCaseSequenceDiagram2.png){ width=0.8\textwidth }
...
![ClassDiagram](ClassDiagram.png){ width=0.8\textwidth }
